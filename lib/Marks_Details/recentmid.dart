...
class recentmid extends StatefulWidget {
  final String recentMid;
  recentmid({required this.recentMid});
  @override
  _recentmidState createState() => _recentmidState();
}

class _recentmidState extends State<recentmid> {
